...
%}
function [LFP,LFPt,thetaLFP] = ThetaLFP(tetNum, ChNum, reduction, RedParm)
if tetNum == 1
    if ChNum == 1
    ...
    elseif reduction == 1
        ...
        N    = 500;      % Order
        win = blackman(N+1);
        RFc1 = 4;      % First Cutoff Frequency
        RFc2 = 12;      % Second Cutoff Frequency
        Rb  = fir1(N, [RFc1 RFc2]/(Fs/2), 'bandpass', win, flag);
        ThetaHd = dfilt.dffir(Rb); % Ripple Filter
