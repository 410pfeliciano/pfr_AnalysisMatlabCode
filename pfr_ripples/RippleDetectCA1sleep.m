...
th = median(smsqfiltLFP(xt1:xt2)) + (2*thMad);
...
th2 = median(smsqfiltLFP(xt1:xt2)) + (6*thMad2);
...
hold on
plot(time, linPos, 'Color', [0.5,0.5,0.5], 'LineWidth', 1)
plot(time(below),linPos(below),'o',...
    'MarkerEdgeColor','k','MarkerFaceColor',[1 0.2 0.2],'MarkerSize', 3)
hold off
% legend('Linear Position','Single Unit Spikes','location','southoutside')
title('Ripple Activity Tet#2')
...
CA1RunRipBelowIdx = sort(RunRipBelowIdx);
CA1RunRipAbovIdx = sort(RunRipAbovIdx);
%%
figure
hold on
plot(time, linPos, 'Color', [0.5,0.5,0.5], 'LineWidth', 1)
plot(time(RunRipBelowIdx),linPos(RunRipBelowIdx),'o',...
    'MarkerEdgeColor','k','MarkerFaceColor',[1 0.2 0.2],'MarkerSize', 3)
hold off
% legend('Linear Position','Single Unit Spikes','location','southoutside')
title('Ripple Activity Tet#2')
