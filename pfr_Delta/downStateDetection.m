...
ctxLFP = ch60Tet11Ctx; %Raw Cortical LFP
...
noiseCandIdx = find(deltaAmpRR <= 55);
...
runtime1 = 220; % Run start time 
runtime2 = 1270; % Run start time 2
